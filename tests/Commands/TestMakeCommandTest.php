...
class TestMakeCommandTest extends BaseTestCase
{
    ...
    {
        $this->app['config']->set('modules.paths.generator.test-unit.path', 'SuperTests/Feature');
    ...
    {
        $this->app['config']->set('modules.paths.generator.test-feature.path', 'SuperTests/Unit');
